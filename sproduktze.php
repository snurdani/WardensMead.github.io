...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/zeleni.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/zeleni.jpg" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/Ginger Medovina</h6>
					<h4>Ginger Medovina 15% Alc</h4>
					<h2>1500din</h2>
					<select>
					...
					<span>predstavljanjem asortimana medovina sa ukusima. Prva na redu je medovina sa limunom i djumbirom. Sadrži 15% 
						alkohola, blaga slatkost sa ljutninom djumbira i kiselošću limuna daje fenomenalno osvežavajuće piće tokom ovih vrućih dana.
					</span>
			</div>
	</section>
