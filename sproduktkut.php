...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/kutija.png" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/kutija.png" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/WardensMeadKutija</h6>
					<h4>WM Kutija za Medovinu</h4>
					<h2>2500din</h2>
					<input type="number" value="1">
					<button class="normal">Dodaj u Korpu</button>
					<h4>Produkt Detalji</h4>
					<span>Elegantna kvalitetna drvena kutija sa logo Wardens Mead
					</span>
			</div>
	</section>
