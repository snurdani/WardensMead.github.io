...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/plavi.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/plavi.jpg" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/Mint Medovina</h6>
					<h4>Mint Medovina 15% Alc</h4>
					<h2>1500din</h2>
					<select>
					...
					<span>Početkom ovogodišnje bazarske sezone smo imali testere za nove medovine i jedna od dva favorita koja će biti u stalnoj proizvodnji je medovina sa mentom.
					</span>
			</div>
	</section>
