...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/ljubicasti.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/ljubicasti.jpg" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/Lavander Medovina</h6>
					<h4>Lavander Medovina 15% Alc</h4>
					<h2>1500din</h2>
					<select>
					...
					<span>Drugi ukus koji je bio izabran od testera početkom ovogodišnje bazarske sezone je medovina sa lavandom.
					</span>
			</div>
	</section>
