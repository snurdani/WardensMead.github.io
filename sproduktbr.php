...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/braon.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/braon.jpg" width="100%" class="small-img" alt="">
							</div>
							<div class="small-img-col">
								<img src="img/banner/mzlatni.jpg" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/Copper Medovina</h6>
					<h4>Copper Medovina 15% Alc</h4>
					<h2>1500din</h2>
					<select>
							<option>kolicina boce</option>
							<option>Velika 1L</option>
							<option>Mala 0.5L</option>
					</select>
					<input type="number" value="1">
					<button class="normal">Dodaj u Korpu</button>
					<h4>Produkt Detalji</h4>
					<span>medovina sa cimetom. Ovoj slatkastoj medovini ukus dodatno daju cejlonski i kasija cimet. Kasija cimet daje klasični oštar ukus cimeta dok cejlonski 
						nam daje slatkaste note koje su veoma blage. Sadrži 15% alkohola može da se pije topla kao i rashladjena
					</span>
			</div>
	</section>
