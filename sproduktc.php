...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/crveni.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/crveni.jpg" width="100%" class="small-img" alt="">
							</div>
							<div class="small-img-col">
									<img src="img/banner/mcrveni.jpg" width="100%" class="small-img" alt="">
							</div>
					</div>
			</div>

			<div class="single-pro-details">
					<h6>Shop/Ruby Medovina</h6>
					<h4>Ruby Medovina Classic 15% Alc</h4>
					<h2>1500din</h2>
					<select>
					...
					<span>Poslednja od naših trenutnih tradicionalnih medovina je Rubin Medovina. 
						Veoma je slatka i sadrži čitavih 18% alkhola. Najbolje se servira kao aperitif ili digestiv. 
					</span>
			</div>
	</section>
