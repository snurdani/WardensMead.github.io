...
<body>
	...
	<section id="prodetails" class="section-p1">
			<div class="single-pro-image">
					<img src="img/banner/zlatni.jpg" width="100%" id="MainImg" alt="">

					<div class="small-img-group">
							<div class="small-img-col">
									<img src="img/banner/zlatni.jpg" width="100%" class="small-img" alt="">
							</div>
							<div class="small-img-col">
			...
			<div class="single-pro-details">
					<h6>Shop/Zlatna Medovina</h6>
					<h4>Zlatna Medovina Classic 15% Alc</h4>
					<h2>1500din</h2>
					<select>
					...
					<span>Zlatna medovina. Kategorizuje se kao slatka medovina i sadrži 15% alkohola. Ima sladak ukus sa 
							izraženim notama meda. Zlatnu uvek preporučujemo za osobe kojima je prvi put da probaju medovinu
					</span>
			</div>
	</section>
