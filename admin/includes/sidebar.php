...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <span class="ms-1 font-weight-bold text-white">MW Database</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "admin.php"? 'active bg-gradiant-primary':''; ?>" href="admin.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "category.php"? 'active bg-gradiant-primary':''; ?>" href="category.php">
            ...
            <span class="nav-link-text ms-1">Sve Kategorije</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "products.php"? 'active bg-gradiant-primary':''; ?>" href="products.php">
            ...
            <span class="nav-link-text ms-1">Svi Produkti</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "add-product.php"? 'active bg-gradiant-primary':''; ?>" href="add-product.php">
            ...
            <span class="nav-link-text ms-1">Dodaj Produkt</span>
          </a>
        </li>
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-info mt-4 w-100" href="../logout.php" 
